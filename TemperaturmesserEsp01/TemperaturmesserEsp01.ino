...
void measureAndSendData() {
  ...
  String url = "/ApiTemperatur/SaveTemperatur?apiSchluessel=C1hoy9KZc5yg4RqO4Ljh&temperatur=" + String(temperature) + "&feuchtigkeit=" + String(humidity) + "&name=Versuch1&geraeteId=2";
